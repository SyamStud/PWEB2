        ...
        <div class="pt-5" style="width: 75%;">
            ...
            <form style="margin-top: 30px;" action="" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?php if ($validation->hasError('nim')) {
                                                                echo 'is-invalid';
                                                            }; ?>" id="validationServerUsernameFeedback" name="nim" value="<?php echo $mahasiswa['nim'] ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?php if ($validation->hasError('nama')) {
                                                                echo 'is-invalid';
                                                            }; ?>" id="validationServerUsernameFeedback" name="nama" value="<?php echo $mahasiswa['nama'] ?>">
                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                        Nama wajib diisi.
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?php if ($validation->hasError('alamat')) {
                                                        echo 'is-invalid';
                                                    }; ?>" id="validationServerUsernameFeedback" rows="3" name="alamat"><?php echo $mahasiswa['alamat'] ?></textarea>
                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                        Alamat wajib diisi.
                    </div>
                </div>
